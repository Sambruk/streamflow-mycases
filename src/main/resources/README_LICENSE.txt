...
Streamflow (tm) Surface MyCases

Copyright 2009-2012 Jayway Products AB

Streamflow (tm) Surface MyCases is licensed under the Apache License, Version 2.0 (the "License"). 
...
The THIRDPARTY file contains information Third Party Software Notices and/or Additional Terms 
and Conditions for Third Party Software released under other licenses than the License.

The THIRDPARTYAPPENDIX file contains information about various licenses. Some of these are
only provided for reference, since they are referred to by other licenses.
